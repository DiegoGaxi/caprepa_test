...
@section('content')
   <div class="flex justify-start">
    ...
    <div class="flex justify-end">
        <a href="{{ route('terms.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">
            Listado de Plazos
        </a>
    </div>
        ...
        <table class="min-w-full divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="uppercase">Plazos (en quincenas)</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach ($montosPrestamo as $monto)
                    <tr>
                        ...
                        <td class="whitespace-nowrap">{{ $monto -> loan_amount_terms -> map(function ($term) { return $term->term; })-> map(function ($term) { return $term->term; }) ->join(', ')}}</td>
